 ...
 */
Instrumentation.prototype.enhanceMethod = function(
    enhanceObject, enhanceMethod, interceptor) {
  ...
  if (!this.isFunction(enhanceObject[enhanceMethod]) ||
      !this.isFunction(interceptor)) {
    return;
  }
