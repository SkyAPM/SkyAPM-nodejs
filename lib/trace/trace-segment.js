...
function TraceSegment() {
    this._traceSegmentId = (((1 + Math.random()) * 0x10000) | 0).toString(16).substring(1);
    this._finishedSpan = new Array();
...
TraceSegment.prototype.fetchEntryOperationNameInfo = function (registerCallback, unregisterCallback) {
