...
var TraceSegment = require('./trace-segment')
var TraceSegmentRef = require('./trace-segment-ref')
...
function TraceContext(parentTraceContext, spanOptions) {
    if (parentTraceContext) {
        this._traceSegment = parentTraceContext._traceSegment;
    } else {
...
TraceContext.prototype.finish = function () {
    this._span.finish.apply(this._span, arguments);
...
TraceContext.prototype.spanId = function () {
    return this._span.getSpanId.apply(this._span, arguments);
}
...
TraceContext.prototype.inject = function (contextCarrier) {
    ...
    var primaryDistributedTraceId = undefined;
    var entryApplicationInstanceId = undefined;
    var traceSegment = this._traceSegment;
    this._traceSegment.fetchRefsInfo(function (refs) {
        var firstSegmentRef = refs[0];
    ...
    contextCarrier.setParentApplicationInstanceId(AgentConfig.getApplicationInstanceId());
}
...
TraceContext.prototype.extract = function (contextCarrier) {
    ...
    var traceSegmentRef = new TraceSegmentRef(contextCarrier);
