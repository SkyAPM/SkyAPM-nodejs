...
ContextCarrier.prototype.serialize = function () {
    var traceContextArray = new Array();
...
ContextCarrier.prototype.deserialize = function (traceContext) {
    ...
    var traceContextSegment = traceContext.split("|");
...
ContextCarrier.prototype.fetchPeerHostInfo = function (registerCallback, unRegisterCallback) {
    if (this._peerHost[0] == '#') {
...
ContextCarrier.prototype.fetchEntryOperationNameInfo = function (registerCallback, unRegisterCallback) {
...
ContextCarrier.prototype.fetchParentOperationNameInfo = function (registerCallback, unRegisterCallback) {
...
ContextCarrier.prototype.isInvalidate = function () {
    return isEmpty(this._traceSegmentId) || isEmpty(this._spanId) || isEmpty(this._parentApplicationInstanceId)
        || isEmpty(this._entryApplicationInstanceId) || isEmpty(this._peerHost) || isEmpty(this._entryOperationName)
        || isEmpty(this._parentOperationName) || isEmpty(this._primaryDistributedTraceId);
...
ContextCarrier.prototype.fetchBy = function (callback) {
    var value = callback(SW_HEADER_KEY);
    this.deserialize(value);
}

ContextCarrier.prototype.pushBy = function (callback) {
    var serializedTracingContext = this.serialize();
