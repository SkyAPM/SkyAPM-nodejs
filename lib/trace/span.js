...
var LogDataEntity = require('./log-data-entity');
...
function Span(spanOptions, traceContext) {
    ...
    console.log("Span[" + this._operationName + ", " + this._parentSpanId + ", " + this._spanId + "] has started.")
}
...
Span.prototype.log = function (err) {
    ...
    var logDataEntity = new LogDataEntity(new Date().getTime(), logEntity)
...
Span.prototype.fetchOperationNameInfo = function (registerCallback, unregisterCallback) {
