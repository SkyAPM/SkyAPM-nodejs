...
ContextManager.prototype.inject = function(contextCarrier) {
  ...
  this._activeTraceContext.prototype.inject.apply(activeTraceContext, [contextCarrier]);
};
...
ContextManager.prototype.extract = function(contextCarrier) {
  ...
  this._activeTraceContext.prototype.extract.apply(activeTraceContext, [contextCarrier]);
};
